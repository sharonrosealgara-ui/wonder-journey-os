...
export const unscheduledLessons: Lesson[] = [
  ...
  },
  {
    ...
    phrases: [
      ...
      { english: "What is your name?", tagalog: "Anong pangalan mo?", hiligaynon: "Ano ang ngalan mo?", pronunciation: "AH-noh ang NGAH-lahn moh" },
  ...
  },
  {
    ...
    order: 19,
    title: "Mayon — The Near-Symmetrical Volcano",
    ...
    sections: [
      {
        ...
        emoji: "🌋",
        body: "Travelers coming into Albay all do the same thing: they go quiet. Rising out of the green fields is a mountain so near-symmetrically shaped it looks drawn with a compass — a flawless cone wearing a scarf of cloud. Farmers plant rice at its feet. Kids race bikes down its lower roads. And every so often, Mayon reminds everyone she's alive, glowing orange at her peak. The people of Bicol love her anyway. They always have.",
      },
      {
        heading: "The Science of the Symmetrical Cone",
        emoji: "🔬",
        body: "Mayon is called the world's most near-symmetrical volcanic cone — and there's real science behind the beauty.",
        bullets: [
