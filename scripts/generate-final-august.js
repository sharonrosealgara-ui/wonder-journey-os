...
const l1 = {
  ...
  mediaMoments: [
    { id: "world-map-ph", description: "World map highlighting the Philippines in Southeast Asia.", purpose: "To show global context.", factualRequirement: "Must clearly show equator and Asian continent.", altTextGuidance: "A world map with the Philippines colored brightly." },
    { id: "namria-radar", description: "Graphic showing how radar mapping finds new islands.", purpose: "Explain the jump from 7,107 to 7,641 islands.", factualRequirement: "Scientific radar representation.", altTextGuidance: "Diagram of satellite mapping islands." },
    { id: "ring-of-fire", description: "Map of the Pacific Ring of Fire.", purpose: "Explain tectonic activity.", factualRequirement: "Must show the Pacific horseshoe shape intersecting the Philippines.", altTextGuidance: "A map showing the red Ring of Fire around the Pacific." }
  ],
  guidedDiscussion: [
  ...
  game: {
    ...
    finishCondition: "All players successfully navigate the islands."
  },
  handsOnTask: {
    ...
    accessibilityAlternative: "If playdough is unavailable, draw the islands or tear pieces of green paper and glue them onto the blue background."
  },
  ...
  factualMediaRequirements: ["world-map-ph", "namria-radar", "ring-of-fire"],
  ...
  sourceNotes: "Data from NAMRIA.",
  mediaAttributionNotes: "Use public domain.",
...
fs.writeFileSync("test.json", JSON.stringify(l1));
console.log("Written test.json");
