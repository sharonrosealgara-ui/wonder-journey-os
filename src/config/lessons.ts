...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    order: 19,
    title: "Mayon â€” The Perfect Volcano",
    ...
    sections: [
      {
        ...
        emoji: "ðŸŒ‹",
        body: "Travelers coming into Albay all do the same thing: they go quiet. Rising out of the green fields is a mountain so perfectly shaped it looks drawn with a compass â€” a flawless cone wearing a scarf of cloud. Farmers plant rice at its feet. Kids race bikes down its lower roads. And every so often, Mayon reminds everyone she's alive, glowing orange at her peak. The people of Bicol love her anyway. They always have.",
      },
      {
        heading: "The Science of the Perfect Cone",
        emoji: "ðŸ”¬",
        body: "Mayon is called the world's most perfect volcanic cone â€” and there's real science behind the beauty.",
        bullets: [
