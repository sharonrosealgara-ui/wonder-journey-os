...
function mapToLegacy(c: CurriculumLesson, order: number, emoji: string): any {
  return {
    ...
    notes: "",
    sections: [
      { heading: "Objective", emoji: "ðŸŽ¯", body: c.learningObjectives.join(", ") },
      { heading: "Fact", emoji: "ðŸ’¡", body: c.factualBackground },
      { heading: "Beginner", emoji: "ðŸŒ±", body: c.activities.beginnerSupport },
      { heading: "Core", emoji: "â­", body: c.activities.coreActivity },
      { heading: "Advanced", emoji: "ðŸš€", body: c.activities.advancedChallenge }
    ],
...
const pilotLessons = stage2Lessons.map((l, i) => mapToLegacy(l, i + 1, "ðŸŒŸ"));

// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// LESSON LIBRARY â€” add new lessons here; pages render them automatically.
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export type PhrasePair = {
  english: string;
  tagalog: string;
  hiligaynon?: string; // legacy â€” kept optional; the app teaches Tagalog only now
...
export const unscheduledLessons: Lesson[] = [
  {
    ...
    notes: "Keep the pace gentle for the first class â€” the goal is wonder, not memorizing.",
    sections: [
      {
        heading: "A Country of Islands",
        emoji: "ðŸï¸",
        body: "The Philippines is made of more than 7,000 islands in the warm Pacific Ocean! Some islands are big with cities and mountains. Some are so tiny that no one lives there â€” just birds, crabs, and coconut trees.",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          "LUZON (north) â€” home of the capital city Manila and the famous Banaue Rice Terraces",
          "VISAYAS (middle) â€” islands of beaches and festivals, including Iloilo and Bago City where Teacher Sharon is from!",
          "MINDANAO (south) â€” land of mountains, fruit farms, and the tallest peak, Mt. Apo",
        ],
      },
      {
        heading: "The Philippine Flag",
        emoji: "ðŸš©",
        body: "The flag has a white triangle with a golden sun and three stars. The sun's eight rays stand for the first eight provinces that fought for freedom. The three stars stand for Luzon, Visayas, and Mindanao â€” the three island groups you just learned!",
        bullets: [
          "Blue stripe â€” peace and justice",
          "Red stripe â€” courage",
          "White triangle â€” equality and hope",
          "Golden sun and 3 stars â€” freedom and the 3 island groups",
        ],
      },
      {
        heading: "Your First Filipino Words",
        emoji: "ðŸ’¬",
        body: "Let's learn to say hello! In the Philippines people greet each other with a warm smile â€” try these greetings out loud together.",
      },
    ],
    phrases: [
    ...
    sections: [
      {
        ...
        emoji: "ðŸ—£ï¸",
        body: "The Philippines has over 170 languages! Today we learn greetings in two of them: Tagalog (spoken in and around Manila and understood everywhere) and Hiligaynon (spoken in Western Visayas â€” Iloilo and Negros, Teacher Sharon's home region).",
      },
      {
        heading: "Speaking Practice",
        emoji: "ðŸŽ¤",
        body: "Say each phrase three times: once slowly, once normally, and once with a big smile. Filipinos say greetings with lots of warmth â€” the smile is part of the word!",
      },
      {
  ...
  },
  {
    ...
    notes: "Storytelling works best here â€” share a real story of hospitality from the Philippines.",
    sections: [
      {
        heading: "Po and Opo â€” Words of Respect",
        emoji: "ðŸ™‡",
        body: "Filipino children show respect for parents and elders with special words: 'po' and 'opo'. Saying 'Opo' instead of just 'yes' to a grandparent is like giving them a little bow with your words. Children also do 'mano po' â€” gently pressing an elder's hand to their forehead to receive a blessing.",
      },
      {
        heading: "Hospitality â€” Everyone Is Welcome",
        emoji: "ðŸ ",
        body: "In a Filipino home, a visitor is always offered food â€” even if the family has little, they share the best they have. Guests are treated like family. 'Kain tayo!' means 'Let's eat!' and you'll hear it the moment you walk in the door.",
      },
      {
        heading: "Bayanihan â€” Helping Together",
        emoji: "ðŸ¤",
      ...
      },
      {
        ...
        emoji: "ðŸ’",
        body: "Filipino families practice gratitude ('utang na loob' â€” a heart that remembers kindness), humility, and caring for God's creation. Helping family is not a chore â€” it is love in action.",
        bullets: [
  ...
  },
  {
    ...
    familyChallenge: "Take a family photo with your finished mango float and upload it to the Family Cookbook! Rate your creation with a family taste test â€” thumbs up scale from 1 to 10 thumbs.",
    notes: "Make it the night before if possible â€” mango float tastes best after chilling overnight.",
    sections: [
      {
        heading: "The Sweetest Fruit in the World",
        emoji: "ðŸ¥­",
        body: "Philippine mangoes are famous â€” the island of Guimaras (right next to Iloilo!) grows mangoes so sweet they once held a world record. Mango float is the dessert every Filipino family makes for birthdays, Christmas... and any day that needs a little sweetness.",
      },
      {
        heading: "Cook Together",
        emoji: "ðŸ‘©â€ðŸ³",
        body: "Open the Mango Float recipe in the Cooking & Baking Studio and follow the steps together. Ezra and Selah â€” this one is for you! Everyone gets a job: slicing (with help), whipping, layering, and the most important job of all... taste testing.",
      },
    ],
    phrases: [
      { english: "Mango", tagalog: "Mangga", hiligaynon: "PahÃ²", pronunciation: "mahng-GAH / pah-HO" },
  ...
  },
  {
    ...
    subtitle: "The national symbols â€” a flower, an eagle, a tree, and a very colorful ride",
    emoji: "ðŸŒ¼",
    category: "Philippines",
    date: "2026-07-22",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Design your own family jeepney! Draw or build (Legos welcome, Ezra and Asa!) a jeepney decorated with things your family loves. Give it a route name â€” where would it drive?",
    notes: "Let each child pick a favorite symbol to present to the family in one sentence â€” tiny practice in confident speaking.",
    sections: [
      {
        heading: "A Treasure Chest of a Country",
        emoji: "ðŸ—ï¸",
        body: "Every country keeps a treasure chest â€” not of gold, but of living things and beloved objects that tell you who its people are. Today we open the Philippines' treasure chest. Inside: a tiny flower with a giant perfume, the king of all eagles, a tree as strong as family, and the most colorful ride on planet Earth.",
      },
      {
        heading: "Sampaguita â€” the National Flower",
        emoji: "ðŸŒ¼",
        body: "The sampaguita is small and white, but in the evening its sweet smell fills whole streets. Filipinos string sampaguita into garlands to welcome guests and honor visitors â€” hospitality you can wear! Its name comes from 'sumpa kita' â€” 'I promise you' â€” a flower of loyalty and love.",
        bullets: [
          "Small, white, star-shaped â€” blooms at night",
          "Sold as fragrant garlands outside churches",
          "Stands for purity, loyalty, and warm welcome",
        ],
      },
      {
        heading: "The Philippine Eagle â€” King of Birds",
        emoji: "ðŸ¦…",
        body: "The Philippine Eagle is one of the largest, rarest eagles in the whole world â€” with a wild crown of feathers and wings wider than a door! It lives only in Philippine forests, which makes protecting those forests a very important job. Caring for this eagle is caring for God's creation.",
        bullets: [
          "One of the biggest eagles on Earth â€” up to 7 feet of wingspan!",
          "Lives ONLY in the Philippines",
          "Endangered â€” fewer than 400 pairs left, so every forest matters",
        ],
      },
      {
        heading: "Narra Tree & Carabao â€” Strong and Faithful",
        emoji: "ðŸŒ³",
        body: "The narra is the national tree â€” hard, golden wood that stands strong through storms, just like a family. And the carabao (water buffalo) is the farmer's faithful best friend, pulling plows through rice fields with quiet patience. Strength plus faithfulness â€” very Filipino treasures.",
      },
      {
        heading: "The Jeepney â€” the Ride with a Smile",
        emoji: "ðŸš™",
        body: "After World War II, Filipinos took leftover army jeeps and transformed them into rainbow-painted, chrome-shining, family-carrying works of art called jeepneys. Every jeepney is decorated differently â€” horses, names, Bible verses, sunbursts! It is creativity and bayanihan on wheels: when you ride, you pass your fare hand-to-hand through other passengers, saying 'Bayad po!' (Here's my payment, please!)",
      },
    ],
    phrases: [
    ...
    reflection: "If our family had a treasure chest of symbols, what five things would be inside it â€” and why?",
  ...
  },
  {
    ...
    subtitle: "Golden crispy banana rolls â€” the sweet smell of Filipino afternoons",
    emoji: "ðŸŒ",
    category: "Cooking",
    recipeId: "turon",
    date: "2026-07-24",
    ...
    notes: "Kids roll, adults fry â€” assembly-line style. Make extra; turon disappears fast.",
    sections: [
      {
        heading: "The Three O'Clock Smell",
        emoji: "ðŸ•’",
        body: "Imagine walking home in a Filipino neighborhood at three in the afternoon. From down the street comes a sound â€” sizzle, sizzle â€” and then THE SMELL: warm caramel and banana. That's the turon cart! Kids appear from everywhere. This is merienda time â€” the beloved Filipino afternoon snack break â€” and today, your kitchen becomes the neighborhood cart.",
      },
      {
        heading: "Merienda â€” the Snack That Gathers People",
        emoji: "ðŸ§º",
        body: "Merienda is more than a snack â€” it's a pause in the day when family and neighbors sit together, share something warm, and talk. Workers stop, kids gather, grandmothers tell stories. Food in the Philippines is never just food; it's an invitation.",
      },
      {
        heading: "Roll Together, Like Lumpia's Sweet Cousin",
        emoji: "ðŸ¤",
        body: "Turon is rolled exactly like lumpia â€” which means it's a family assembly line! One person sugars the bananas, one rolls, one seals with water. Open the Turon recipe in the Cooking & Baking Studio and follow the steps. Remember the golden rule: rolling is a kid job, frying is 100% an adult job.",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    familyChallenge:
      "Before class, each explorer prepares 2 interview questions for Teacher Sharon â€” one about growing up in the Philippines, and one about her favorites (food? animal? place?). Ask them live during class!",
    notes: "This episode is mostly conversation â€” share photos of home, answer their questions, and let the relationship grow. Personalize the sections below with your own stories!",
    sections: [
      {
        heading: "A Letter Across the Ocean",
        emoji: "âœ‰ï¸",
        body: "Imagine getting a letter from the other side of the world: 'Dear explorers â€” while you are eating breakfast, I am watching the sunset. While you have winter, I have mangoes. Come and see my world!' Today the letter-writer introduces herself: your guide for this whole adventure, Teacher Sharon.",
      },
      {
        heading: "From the Land of Sugar and Smiles",
        emoji: "ðŸŒ±",
        body: "Teacher Sharon comes from Negros Occidental in the Visayas â€” the 'Sugarbowl of the Philippines,' where green sugarcane fields stretch to the mountains. Her language is Hiligaynon, called one of the sweetest-sounding languages in the world â€” from the sweetest-sounding region, of course!",
        bullets: [
          "Home region: Negros Occidental, Western Visayas",
          "Home language: Hiligaynon â€” 'Kamusta!'",
      ...
      },
      {
        ...
        emoji: "ðŸŽ¤",
        body: "Now it's your turn to be explorers AND reporters. Ask Teacher Sharon your prepared questions! Listen for one surprising thing â€” you'll write it in your journal afterward.",
      },
      {
  ...
  },
  {
    ...
    notes: "Share your own photos of Bago in the Canva deck â€” real photos of real places beat any stock image.",
    sections: [
      {
        heading: "The Green Ocean",
        emoji: "ðŸŒ¾",
        body: "Close your eyes and picture an ocean â€” but green. Waves of tall sugarcane swaying in the wind, as far as you can see, with blue mountains standing behind them. That's the road to Bago City, Teacher Sharon's hometown in Negros Occidental. Locals call Negros the 'Sugarbowl of the Philippines' â€” and today you'll see why.",
      },
      {
        heading: "A City of Farms and Waterfalls",
        emoji: "ðŸ’§",
        body: "Bago City is one of the biggest rice and sugar producers in the region â€” a hardworking farm city. But hidden in its green hills are treasures: waterfalls like Kipot Falls where families swim on hot days, and rivers that water all those fields. Farm work in front, adventure in the back!",
        bullets: [
      ...
      },
      {
        ...
        emoji: "ðŸ¥„",
        body: "Put one small spoonful of sugar on your tongue. As it melts, think about its journey: a farmer in a field like Bago's planted cane under the hot sun, harvested it, and a mill turned it into these sparkling crystals â€” which crossed the ocean to your kitchen. Sweetness is somebody's hard work. 'Salamat' to farmers!",
      },
      {
        heading: "Home Is Worth Knowing",
        emoji: "ðŸ ",
        body: "Every place on Earth is somebody's hometown â€” somebody's fields, somebody's waterfall, somebody's Sunday afternoon. Today Bago City stopped being a dot on the map and became a real place where your friend grew up. That's what explorers do: they turn dots into homes.",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    canvaLink: "https://www.canva.com/",
    videoLinks: [
      { label: "A day in the life â€” Filipino kids (search on YouTube)", url: "https://www.youtube.com/results?search_query=day+in+the+life+filipino+kids" },
    ...
    sections: [
      {
        ...
        emoji: "ðŸ“",
        body: "It's 5:30 AM somewhere in the Philippines, and the neighborhood rooster is louder than any alarm clock. A Filipino kid wakes up, and the first stop is grandma â€” taking her hand and pressing it gently to the forehead. 'Mano po.' It means: bless me, I honor you. Every single morning begins with respect.",
      },
      {
        heading: "The Sari-Sari Store",
        emoji: "ðŸª",
        body: "On nearly every street corner stands a sari-sari store â€” a tiny window-shop attached to a neighbor's house, selling a little bit of EVERYTHING ('sari-sari' means 'variety'!). Candy, soap, ice water, one egg, a single banana cue stick. Kids run errands there all day: 'Bili ka ng suka!' â€” go buy vinegar! It's the neighborhood's kitchen cupboard and news station in one.",
      },
      {
        heading: "School, Jeepneys, and Games",
        emoji: "ðŸŽ’",
        body: "Kids ride jeepneys or tricycles to school in bright white-and-colored uniforms. After school? Street games! Patintero (tag with lines), tumbang preso (knock down the can), luksong baka (leapfrog â€” literally 'jump over the cow'!). No batteries needed â€” just chalk, a can, and a whole street of friends.",
        bullets: [
          "Mano po to elders â€” every morning, every visit",
          "Jeepney or tricycle rides to school",
          "Street games with the whole neighborhood",
          "Merienda at three o'clock â€” always",
        ],
      },
      {
        heading: "Evening: Family Around the Table",
        emoji: "ðŸš",
        body: "Dinner is rice (always rice!) with the whole family â€” often grandparents too, because many Filipino homes hold three generations under one roof. After dinner: stories, teasing, maybe karaoke (Filipinos LOVE karaoke). The day ends the way it began â€” together.",
      },
      {
    ...
    reflection: "Which part of a Filipino kid's day would you most like to try â€” and which part of YOUR day do you think they would enjoy?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },

  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // AUGUST â€” "Islands & Words" (Season Calendar, Units 5 Â· 2 Â· 7)
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    id: "luzon-land-of-the-rising-capital",
    order: 10,
    title: "Luzon â€” Land of the Rising Capital",
    ...
    familyChallenge:
      "Build your own jeepney from a shoebox or blocks â€” paint it bright, give it a name like real drivers do, and draw the route map of YOUR town for its first trip!",
    notes: "Regional intro â€” the Banaue, Mayon, and Palawan episodes award this month's stamps.",
    sections: [
      {
        heading: "The City That Wakes Before the Sun",
        emoji: "ðŸŒ…",
        body: "It is 4:30 in the morning in Manila, and Mang Ben is already polishing his jeepney â€” a long, shiny silver bus-car covered in painted horses, family names, and little flags. Before the sun is even up, his jeepney rumbles to life and joins thousands of others, carrying students, lolas with market baskets, and workers across the biggest island in the Philippines. Climb in â€” today, Luzon is our route!",
      },
      {
        heading: "One Giant Island, a Thousand Faces",
        emoji: "ðŸ—ºï¸",
        body: "Luzon is the largest of the three island groups â€” so big it holds almost every kind of place you can imagine.",
        bullets: [
          "Home of Manila, the capital city, and Quezon City, the biggest city",
          "The cool Cordillera mountains in the north â€” where the rice terraces climb the sky (next Monday's adventure!)",
          "Fiery volcanoes like Mayon and Taal â€” and black-sand beaches beneath them",
          "More than half of all Filipinos live on Luzon",
        ],
      },
      {
        heading: "Manila â€” the Capital by the Bay",
        emoji: "ðŸ™ï¸",
        body: "Manila sits beside a bay famous for the most beautiful sunsets in Asia. Inside the city hides Intramuros â€” 'the walled city' â€” with stone walls over 400 years old that you can walk on top of! Nearby is Rizal Park, named for the national hero the kids will meet again and again on this journey.",
        bullets: [
          "Intramuros â€” a Spanish-era walled city you can explore by bamboo bike",
          "Manila Bay â€” famous worldwide for its orange-pink sunsets",
          "Jeepneys everywhere â€” the 'kings of the road,' each one decorated like a rolling artwork",
        ],
      },
      {
    ...
    reflection: "If your family had its own jeepney, what would you paint on it â€” and where would its very first route go?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    subtitle: "Ate, Kuya, Lola, Lolo â€” every person in a Filipino family has a special name",
    ...
    familyChallenge:
      "Make a family tree poster with photos or drawings â€” label every person with their Filipino title. Then use Ate, Kuya, Manang, and Manong for each other ALL WEEK. (Rylee and Ezra just became Ate and Kuya!)",
    notes: "Teacher: please double-check the Hiligaynon terms below â€” your ear is final. Word set also lives in config/languages.ts (Family Words).",
    sections: [
      {
        heading: "Sunday at Lola's House",
        emoji: "ðŸ¡",
        body: "The tricycle stops in front of a blue house and the door bursts open before you even knock. 'Apo!' cries Lola, pulling you in. Inside, Ate Liza is setting the table, Kuya Miko is carrying a giant pot of rice, and Tatay is laughing at something Nanay said. In a Filipino home, nobody is just a name â€” everyone has a TITLE that says 'you belong to me, and I belong to you.'",
      },
      {
        heading: "Who's Who sa Pamilya",
        emoji: "ðŸ’›",
        body: "These titles are little gifts of respect â€” using them tells someone their place in your heart.",
        bullets: [
          "Ate (AH-teh) â€” older sister Â· Kuya (KOO-yah) â€” older brother (Tagalog)",
          "Manang â€” older sister Â· Manong â€” older brother (Hiligaynon, Teacher Sharon's home words!)",
          "Lola â€” grandmother Â· Lolo â€” grandfather â€” the most beloved words in any Filipino house",
          "Even friends and neighbors get titles â€” a kind older lady is 'Tita,' a family friend is 'Tito'",
        ],
      },
      {
        heading: "Po and Opo Live at Home",
        emoji: "ðŸ™",
        body: "Remember 'po' and 'opo,' the respect words? Their favorite place is inside the family. 'Opo, Lola' â€” yes, grandmother. 'Salamat po, Tatay' â€” thank you, father. Respect isn't a rule in a Filipino family; it's the way love talks.",
      },
      {
        heading: "Your Words for the People You Love",
        emoji: "ðŸ’¬",
        body: "Say each one out loud â€” then look at the person in YOUR family it belongs to and say it to them!",
      },
    ],
    phrases: [
    ...
    reflection: "Which family title feels the most special to you â€” and who in your family will you call by their Filipino title first?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    subtitle: "The dessert whose name means 'mix-mix' â€” everything wonderful in one glass",
    emoji: "ðŸ§",
    category: "Cooking",
    recipeId: "halo-halo",
    date: "2026-08-07",
    ...
    familyChallenge:
      "Invent your family's OWN halo-halo layer! Each explorer adds one ingredient nobody expects â€” name your creation and draw its 'menu card' for the Family Cookbook.",
    notes: "Teacher: verify Hiligaynon kitchen words below. Grandma Jeannie will love this one â€” layering is a perfect job for many hands.",
    sections: [
      {
        heading: "The Bell on the Hottest Day",
        emoji: "ðŸ””",
        body: "It is the hottest afternoon of April in Bacolod, the kind where even the dogs nap in the shade. Then â€” kiling-kiling! â€” a little bell rings down the street, and every kid on the block sits straight up. The halo-halo cart is coming! Crushed ice, purple ube, sweet bananas, jellies like little jewels, and milk poured over everything. One glass, a hundred colors, and the whole street lines up smiling.",
      },
      {
        heading: "What Does Halo-Halo Mean?",
        emoji: "ðŸ¥„",
        body: "'Halo' means MIX â€” so halo-halo means 'mix-mix!' The magic rule: everything goes in together, and somehow it all belongs. Sweet beans next to jelly, ice next to flan, purple yam on top. A little like a family, isn't it? Different colors and flavors â€” one wonderful glass.",
        bullets: [
          "Layered, never stirred â€” until YOU mix it at the table (that's the fun part)",
          "Ube (purple yam) makes it purple, leche flan makes it golden",
          "Every region â€” and every family â€” builds theirs differently",
        ],
      },
      {
        heading: "Kitchen Words for Today",
        emoji: "ðŸ’¬",
        body: "Cooks in the Philippines call across the kitchen in these words â€” now your kitchen can too!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 13,
    title: "Banaue â€” Stairways to the Sky",
    subtitle: "Rice terraces carved by hand two thousand years ago â€” and still growing rice today",
    emoji: "ðŸŒ¾",
    category: "Philippines",
    ...
    familyChallenge:
      "Build your own mini rice terraces! Layer soil or playdough into stair-steps in a tray, hold the walls with cardboard, and plant real seeds on each step. Water them all month and watch your mountain turn green â€” just like the Ifugao. (Asa, this one's yours to lead!)",
    notes: "Awards the Banaue passport stamp. Strong bayanihan tie-in â€” the terraces are Unit 4 values made visible.",
    sections: [
      {
        heading: "The Grandmother on the Mountain Stairs",
        emoji: "ðŸŒ„",
        body: "High in the cold morning mist of the Cordillera mountains, Apo Rosa walks a narrow green ledge the way her mother did, and her mother's mother, back further than anyone can count. On her back is a basket of rice seedlings. Below her â€” and above her â€” the whole mountain is carved into giant green steps, like a stairway built for the sky itself. Her family didn't buy this mountain. They didn't find it this way. Two thousand years ago, her ancestors carved it â€” by hand.",
      },
      {
        ...
        bullets: [
          "Carved around 2,000 years ago by the Ifugao people â€” with hand tools, no machines",
          ...
          "They are STILL farmed today â€” the same families, the same rice, parent to child to grandchild",
        ],
      },
      {
        heading: "Built the Bayanihan Way",
        emoji: "ðŸ¤",
        body: "Remember bayanihan â€” the whole village lifting the house together? The terraces are bayanihan carved into a mountain. No single family could build them. Neighbors carved together, shared water down the steps fairly, and repaired each other's walls after storms â€” for two thousand years. When you see the terraces, you're not just seeing farming. You're seeing what 'helping each other' looks like when it never, ever stops.",
      },
      {
        heading: "Words from the Rice Mountain",
        emoji: "ðŸ’¬",
        body: "Rice has different names for every stage of its life in the Philippines â€” that's how much it matters. Say them out loud!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    subtitle: "Count to ten in two languages â€” then buy mangoes like a pro",
    emoji: "ðŸ”¢",
    category: "Language",
    date: "2026-08-12",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Open your own sari-sari store at home! Price 5 items with paper tags (in pesos!), take turns as shopkeeper and shopper, and do all the counting out loud in Tagalog or Hiligaynon. Shopkeeper Ezra, what's three mangoes at 10 pesos each? (Psst â€” that's times tables sneaking in. Don't tell anyone.)",
    notes: "Unit 2 Numbers â€” deliberately seeds Shaun's times-tables request through market pricing. Teacher: verify Hiligaynon numbers.",
    sections: [
      {
        heading: "Tuesday at the Palengke",
        emoji: "ðŸ§º",
        body: "The palengke â€” the market â€” is the loudest, most wonderful place in town on a Tuesday morning. 'Mangga! Tig-singkwenta!' calls Aling Nena from behind a golden mountain of mangoes. Nanay squeezes one, sniffs it like an expert, and holds up three fingers. Now comes the magic part â€” the counting, the pesos, the friendly back-and-forth. In the market, numbers aren't homework. Numbers are how you get mangoes.",
      },
      {
        heading: "One to Ten, Two Ways",
        emoji: "ðŸ”Ÿ",
        body: "Tagalog and Hiligaynon count almost like cousins â€” some numbers are twins, some wear different clothes. Listen for which is which!",
        bullets: [
          ...
          "Fun secret: for MONEY and TIME, Filipinos often switch to Spanish numbers â€” uno, dos, tres! A market price is 'singkwenta' (50)",
        ],
      },
      {
        heading: "Market Math â€” the Explorer's Times Table",
        emoji: "ðŸ¥­",
        body: "Here's where counting becomes power. If one mango costs 10 pesos... two mangoes cost 20... three cost 30! You just did multiplication the market way â€” no worksheet, just mangoes. Every market kid in the Philippines learns numbers exactly like this: by helping, buying, and counting change.",
      },
      {
        heading: "Say Your Numbers Loud!",
        emoji: "ðŸ’¬",
        body: "Count everything today â€” steps, spoons, siblings. Out loud, both languages, big voice!",
      },
    ],
    phrases: [
    ...
    reflection: "Where do numbers show up in YOUR family's day? Could you do tomorrow's counting â€” steps, plates, toys â€” in Tagalog or Hiligaynon?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    familyChallenge:
      "Before mixing, make Fruit Rainbow Art: arrange your fruit on a big plate in rainbow order and let Selah direct the design. Photograph it for the Family Cookbook â€” THEN mix it into the bowl. Art first, dessert second!",
    notes: "Fiesta/celebration dish framing (per family guidelines). Grandma Jeannie's travel-and-cooking stories fit beautifully here â€” invite her to share a fruit memory.",
    sections: [
      {
        heading: "The Bowl That Comes Out for Happy Days",
        emoji: "ðŸŽ‰",
        body: "In every Filipino kitchen there is one big glass bowl that only comes out when something wonderful is happening â€” a birthday, a graduation, a fiesta, a homecoming. And when the cousins see Lola reaching for that bowl, a cheer goes up, because everyone knows what's coming: creamy, dreamy, ice-cold fruit salad. Sweet corn kernels of young coconut, golden fruit cocktail, and the secret every family argues about lovingly â€” how much cream is 'enough'.",
      },
      {
        ...
        bullets: [
          "Golden fruit cocktail and ripe mango â€” the sunshine layer",
          "Soft white buko (young coconut) â€” the cloud layer",
          "Red cherries or strawberries on top â€” the crown jewels",
      ...
      },
      {
        ...
        emoji: "ðŸ‘¨â€ðŸ‘©â€ðŸ‘§â€ðŸ‘¦",
        body: "Ask ten Filipino families for their fruit salad recipe and you'll get ten proud answers. Some add cheese (yes, cheese â€” try it before you laugh!), some add jelly pearls, some guard a secret ingredient for generations. Today YOUR family starts its own version â€” whatever you add today becomes 'how we've always made it' tomorrow.",
      },
      {
        heading: "Sweet Words for a Sweet Day",
        emoji: "ðŸ’¬",
        body: "Fruit names are some of the happiest words in any language â€” say them like you're at the market!",
      },
    ],
    phrases: [
    ...
    reflection: "What ingredient did YOUR family add to make the fruit salad your own â€” and what happy day will you make it for next?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    id: "visayas-our-home-islands",
    order: 16,
    title: "Visayas â€” Our Home Islands",
    subtitle: "The middle islands where Teacher Sharon grew up â€” beaches, festivals, and Hiligaynon hearts",
    emoji: "ðŸï¸",
    category: "Philippines",
    date: "2026-08-17",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Fold a fleet of paper boats â€” one for each explorer â€” and name them after Visayan islands. Then 'sail' them across a blue blanket sea from island to island while Teacher Sharon tells you what makes each one special.",
    notes: "Regional intro â€” Teacher Sharon's personal geography! Iloilo & Bago stamps were earned in July; Cebu/Bohol/Boracay stamps come with their own future episodes.",
    sections: [
      {
        heading: "The Ferry Horn at First Light",
        emoji: "â›´ï¸",
        body: "A deep horn sounds across the water â€” HHRRRMMM! â€” and the big white ferry pulls away from Iloilo's port, its deck full of sleepy passengers, sacks of mangoes, and one excited grandmother going home to Negros. In the Visayas, the sea isn't a wall between places. It's the ROAD. Islands here are neighbors who wave at each other across the water â€” and today, we're sailing right through the middle of Teacher Sharon's world.",
      },
      {
        heading: "The Middle Kingdom of Islands",
        emoji: "ðŸ—ºï¸",
        body: "The Visayas is the heart of the Philippines â€” thousands of islands gathered like a family around a dinner table of sea.",
        bullets: [
          "The big siblings: Panay (Iloilo!), Negros (Bago City!), Cebu, Bohol, Leyte, Samar",
          "Home of the country's most famous beaches â€” including Boracay's powder-white sand",
          "Where Hiligaynon and Cebuano are spoken â€” the languages of markets, lullabies, and Lola's kitchen",
      ...
      },
      {
        ...
        emoji: "ðŸ’›",
        body: "Somewhere on that map, between Panay and Negros, is the stretch of water Teacher Sharon has crossed her whole life â€” the Guimaras Strait, where the sweetest mangoes on Earth grow on the little island in the middle (you already earned that stamp!). When she says 'home,' this is the blue and green she means. Today, ask her anything about it â€” this is the lesson where your teacher IS the textbook.",
      },
      {
        heading: "Words That Cross the Water",
        emoji: "ðŸ’¬",
        body: "Sea words, island words â€” the vocabulary of a Visayan childhood. Say them like the ferry horn: loud and happy!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 17,
    title: "Hiligaynon â€” Your First Sentences",
    subtitle: "Teacher Sharon's home language â€” now YOU can speak it in whole sentences",
    emoji: "ðŸ—£ï¸",
    category: "Language",
    date: "2026-08-19",
    time: "9:00 AM",
    ...
    notes: "Unit 3 â€” Hiligaynon as a first-class language, never a footnote. Teacher: these sentences are yours to correct and re-record in your own voice someday.",
    sections: [
      {
        heading: "The Language That Sings",
        emoji: "ðŸŽµ",
        body: "People in Iloilo and Negros say their language is malambing â€” sweet, gentle, almost sung instead of spoken. When two Ilonggos meet far from home, they can hear it in each other's voices in three words flat, and suddenly they're family. Today you learn to make whole sentences in the language Teacher Sharon dreamed in as a little girl. Speak them softly â€” this language likes kindness.",
      },
      {
        ...
        bullets: [
          "Kamusta ka? â€” How are you? Â· answer: Maayo man! â€” I'm fine!",
          "Ano ang ngalan mo? â€” What is your name? Â· Ako si ___ â€” I am ___",
          "Gutom na ako! â€” I'm hungry! (the most useful sentence in any language)",
          "Palangga ta ka â€” I love you (say THIS one at home tonight ðŸ’›)",
        ],
      },
      {
        heading: "Speak It Like Home",
        emoji: "ðŸªž",
        body: "Hold the mirror and watch your mouth as you speak â€” Hiligaynon vowels are round and open, like the language is smiling. Don't worry about mistakes; Ilonggos famously love ANYONE who tries their language. Every sentence you attempt is a gift to your teacher.",
      },
      {
        heading: "Today's Sentences",
        emoji: "ðŸ’¬",
        body: "Practice each pair â€” question and answer, like a tiny conversation. Partner up!",
      },
    ],
    phrases: [
    ...
    reflection: "'Palangga ta ka' â€” who did you say it to, and what did their face do?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    subtitle: "The after-school street snack on a stick â€” caramel, bananas, and happy lines",
    emoji: "ðŸŒ",
    category: "Cooking",
    recipeId: "banana-cue",
    date: "2026-08-21",
    ...
    familyChallenge:
      "Set up a Banana Cue Stand at snack time â€” a real sign, real prices in pesos (Numbers to Market skills!), and family members as customers. Shopkeepers must take orders in Tagalog or Hiligaynon.",
    notes: "Safety emphasis: caramelizing sugar is a grown-ups-only step â€” kids skewer, count, sell, and eat. Ties back to the Numbers lesson beautifully.",
    sections: [
      {
        heading: "Three O'Clock at the Corner Stand",
        emoji: "ðŸª",
        body: "School's out, and half the neighborhood is walking the same direction â€” toward the sizzle. At the corner, Aling Baby stands over a huge black pan where saba bananas tumble in bubbling golden caramel. She spears three onto a stick â€” thunk, thunk, thunk â€” and hands it over, still warm, sugar crackling like glass. Fifteen pesos of pure happiness. That's banana cue: the snack that ends every Filipino school day sweetly.",
      },
      {
        heading: "Why 'Cue'?",
        emoji: "ðŸ¢",
        body: "The name is a funny story: it comes from 'barbecue' â€” because it's served on a barbecue stick! Filipinos love putting snacks on sticks.",
        bullets: [
          "Made with saba â€” a chunky cooking banana, sturdier and less sweet than eating bananas",
      ...
      },
      {
        ...
        emoji: "ðŸ”¥",
        body: "Watch (from a safe distance!) what heat does to plain brown sugar: it melts, turns to liquid gold, then hardens into glassy candy on the banana. That's caramelization â€” real kitchen chemistry! The grown-ups handle the hot pan; explorers handle the skewers, the counting, and the taste-testing. Everyone handles the eating.",
      },
      {
        heading: "Snack-Stand Words",
        emoji: "ðŸ’¬",
        body: "Every street-food stand runs on these words â€” practice for your family stand!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 19,
    title: "Mayon â€” The Near-Symmetrical Volcano",
    subtitle: "The most beautiful â€” and most dramatic â€” mountain in the Philippines",
    emoji: "ðŸŒ‹",
    category: "Philippines",
    destinationId: "mayon",
    date: "2026-08-24",
    ...
    familyChallenge:
      "Build and ERUPT your own Mayon! Paper-cone volcano on a tray, baking soda inside, vinegar with red coloring poured in â€” stand back and cheer. Then rebuild the villages around it with blocks, because that's what Bicolanos have always done: live bravely beside beauty.",
    ...
    sections: [
      {
        ...
        emoji: "ðŸŒ‹",
        body: "Travelers coming into Albay all do the same thing: they go quiet. Rising out of the green fields is a mountain so near-symmetrically shaped it looks drawn with a compass â€” a flawless cone wearing a scarf of cloud. Farmers plant rice at its feet. Kids race bikes down its lower roads. And every so often, Mayon reminds everyone she's alive, glowing orange at her peak. The people of Bicol love her anyway. They always have.",
      },
      {
        heading: "The Science of the Symmetrical Cone",
        emoji: "ðŸ”¬",
        body: "Mayon is called the world's most near-symmetrical volcanic cone â€” and there's real science behind the beauty.",
        bullets: [
          "A stratovolcano: built layer by layer from its own eruptions, like nature icing a cake for 20,000 years",
          "About 2,462 meters tall â€” the pride of the Bicol region of Luzon",
          "The most active volcano in the Philippines â€” scientists watch it around the clock",
          "'Mayon' comes from 'Magayon' â€” the Bicolano word for BEAUTIFUL",
        ],
      },
      {
        heading: "Living Beside a Giant",
        emoji: "ðŸ¡",
        body: "Why do families farm beside a volcano? Because volcano soil is a GIFT â€” ash makes the land unbelievably rich, growing the greenest rice and the famous spicy Bicol chilies. When Mayon stirs, neighbors help neighbors move to safety â€” bayanihan again! â€” and when she calms, they return and replant. It's one of the bravest, most beautiful friendships between people and nature on Earth.",
      },
      {
        heading: "Fire Mountain Words",
        emoji: "ðŸ’¬",
        body: "Words for the day the ground rumbles â€” say them with drama!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    subtitle: "Paint your words â€” every color in Tagalog and Hiligaynon",
    emoji: "ðŸŽ¨",
    category: "Language",
    date: "2026-08-26",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Color Scavenger Hunt! Teacher calls a color in Tagalog or Hiligaynon â€” explorers race to bring back something in that color. Last round: everyone paints a mini Philippine flag and labels its colors in both languages.",
    notes: "Unit 2/3 â€” links back to the flag lesson (Lesson 1) beautifully. Selah's drawing unit-let!",
    sections: [
      {
        heading: "The Jeepney Painter's Rainbow",
        emoji: "ðŸ–Œï¸",
        body: "In a workshop in Manila, Mang Rudy dips his brush and lays a stripe of screaming pink down the side of a jeepney, right next to electric blue, mango yellow, and apple green. 'In the Philippines,' he laughs, 'we don't choose ONE color. We choose ALL of them.' Look around any Filipino street â€” the tricycles, the fiesta banners, the halo-halo â€” this is a country that speaks in color. Today, you learn to speak it back.",
      },
      {
        heading: "Your Color Words",
        emoji: "ðŸŒˆ",
        body: "Some colors are twins in both languages, some are cousins â€” listen closely!",
        bullets: [
          "Twins: pula (red), asul (blue), berde (green), puti (white) â€” same in both!",
          "Cousins: yellow is dilaw in Tagalog but dalag in Hiligaynon; black is itim vs itom",
          "Flag check: what colors did we learn in Lesson 1? Pula, asul, puti, dilaw â€” now say the flag in Filipino!",
        ],
      },
      {
        heading: "Colors That Mean Something",
        emoji: "ðŸš©",
        body: "Remember the flag: blue for peace, red for courage, white for hope, gold for freedom. Colors in the Philippines aren't just pretty â€” they carry meaning. Fiesta banners are every color at once because a fiesta celebrates EVERYTHING. What color would your family choose to mean 'us'?",
      },
      {
        heading: "Say It in Color",
        emoji: "ðŸ’¬",
        body: "Point at things while you say them â€” color words stick when your finger helps!",
      },
    ],
    phrases: [
    ...
    reflection: "If your family were a color, which would it be â€” and how do you say it in Tagalog and Hiligaynon?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    id: "chicken-adobo-family-feast",
    order: 21,
    title: "Chicken Adobo â€” The Family Feast",
    subtitle: "The unofficial national dish â€” every Filipino family's most argued-about recipe",
    emoji: "ðŸ—",
    category: "Cooking",
    ...
    familyChallenge:
      "The Adobo Council: after tasting, the whole family votes on ONE change for your next batch â€” more garlic? sweeter? extra sauce? Write your official family adobo rules in the Cookbook. This recipe will now evolve for generations. Handle with care.",
    notes: "The big one â€” Ezra's episode. Grandma Jeannie's cooking wisdom formally requested. Longer cook time; start the pot early in class.",
    sections: [
      {
        heading: "The Smell That Means 'Come Home'",
        emoji: "ðŸ ",
        body: "Ask any Filipino living far away what smell makes them homesick, and you'll get one answer: adobo day. Garlic hitting the pan. Soy sauce and vinegar starting their slow, magical argument. Bay leaves floating like little boats. It's the smell that pulled kids in from the street for a hundred years â€” the smell that says someone loves you enough to make the good dinner.",
      },
      {
        heading: "The Dish That Keeps Itself",
        emoji: "ðŸ§ª",
        body: "Adobo has a secret superpower â€” it was invented before refrigerators, and it PRESERVES itself.",
        bullets: [
          "Vinegar + salt + garlic keep the meat good for days â€” old-time Filipino food science!",
          ...
          "There is no single 'true' adobo â€” there is only YOUR family's adobo",
        ],
      },
      {
        heading: "The Great Adobo Debate",
        emoji: "âš–ï¸",
        body: "Tonight your family joins a debate as old as the dish: sauce-y or dry? Sweet or sharp? Potatoes â€” genius or crime? Filipino families defend their adobo style like a family crest, because that's what it is. Whatever you decide today becomes the founding recipe of the Ferrell adobo dynasty. Choose wisely. Or deliciously. Ideally both.",
      },
      {
  ...
  },
  {
    ...
    order: 22,
    title: "Palawan â€” The Last Frontier",
    ...
    notes: "Awards the Palawan passport stamp â€” completing August's island collection. Strong stewardship/creation-care thread (Unit 10 preview).",
    sections: [
      {
        heading: "The River That Swallows Boats",
        emoji: "ðŸ›¶",
        body: "The paddle dips quietly. Your little boat slides toward a cliff face â€” and then, a mouth in the rock, and the world goes dark and cool. You're floating INSIDE a mountain now, on a river that runs underground for kilometers, past rock formations shaped like vegetables and cathedrals, while sleepy swiftlets chirp somewhere above. This is Palawan's Underground River â€” one of the New 7 Wonders of Nature â€” and it's real, and it's in the Philippines.",
      },
      {
        ...
        bullets: [
          "The Puerto Princesa Underground River â€” over 8 km of river inside a mountain",
          "El Nido and Coron â€” turquoise lagoons between black limestone cliffs that look painted",
          "Home to animals found almost nowhere else: mouse-deer, bearcats, peacock-pheasants, giant sea turtles",
          "Voted the world's most beautiful island â€” more than once!",
        ],
      },
      {
        heading: "Keeping the Frontier Wild",
        emoji: "ðŸŒ±",
        body: "Here's what makes Palawan truly special: Filipinos have fought hard to KEEP it this way. Visitor numbers to the Underground River are limited every day. Divers protect the reefs. Kids in Palawan grow up learning that the island isn't theirs to use up â€” it's theirs to take care of. God's creation, kept carefully â€” stewardship you can see from a boat. (Nature Explorers unit is coming in October, Asa â€” this is your preview.)",
      },
      {
        heading: "Explorer Words for Wild Places",
        emoji: "ðŸ’¬",
        body: "The vocabulary of caves, rivers and wild islands â€” whisper them like you're inside the cave!",
      },
    ],
    phrases: [
    ...
    reflection: "Palawan stays beautiful because people choose to protect it. What's one beautiful thing â€” a place, a habit, a friendship â€” your family wants to protect together?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },

  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // SEPTEMBER â€” "Creatures & Character" (Units 2 Â· 8 Â· 6 Â· 4)
  // â­ Feast season: Sep 21 (Day of Atonement) is marked no-class in
  // the Season Calendar; Tabernacles week (~Sep 28â€“Oct 2) pauses.
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    subtitle: "The words that fill a Filipino table â€” say them and you'll never go hungry",
    emoji: "ðŸš",
    category: "Language",
    date: "2026-09-02",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Play 'Merienda Market'! Set out real or toy food, put paper-peso prices on each, and take turns buying snacks â€” but you can only ask for food using its Tagalog or Hiligaynon name. No name, no snack!",
    notes: "Unit 2/3 vocabulary. Teacher: verify Hiligaynon food terms below.",
    sections: [
      {
        heading: "The Table That Always Has Room",
        emoji: "ðŸ½ï¸",
        body: "Walk past any Filipino home around noon and you'll hear the same beautiful sentence float out the window: 'Kain tayo!' â€” Let's eat! It isn't just an invitation to family. It's for the neighbor, the delivery driver, the friend who 'just dropped by.' In the Philippines, there is always one more plate, always more rice in the pot. Food isn't only for filling tummies â€” it's how love is served. Today you learn the words for the fullest table in the world.",
      },
      {
        heading: "The Words on Every Plate",
        emoji: "ðŸ›",
        body: "Rice is the center of every Filipino meal â€” so important it has its own words. Around it goes everything else!",
        bullets: [
          "Kanin (rice) is the star â€” a meal without rice barely counts as a meal!",
          "Ulam is the word for 'the thing you eat WITH rice' â€” chicken, fish, vegetables, anything",
          "Manok (chicken), isda (fish), gulay (vegetables), itlog (egg) â€” the everyday ulam",
          "Tubig (water) and, for merienda, something sweet â€” your halo-halo and banana cue!",
        ],
      },
      {
        heading: "From Hungry to Happy-Full",
        emoji: "ðŸ˜‹",
        body: "Filipinos have a wonderful word most languages don't: 'busog' â€” that warm, sleepy, perfectly-full feeling after a good meal. You go from 'gutom' (hungry) to 'busog' (full), and the whole journey is delicious. When someone feeds you well, the kindest thank-you is: 'Salamat, busog na ako!' â€” Thank you, I'm full!",
      },
      {
        heading: "Say It Before You Eat It",
        emoji: "ðŸ’¬",
        body: "Point at each food and say its name before your next meal â€” your tummy will learn the words with you!",
      },
    ],
    phrases: [
      { english: "Let's eat!", tagalog: "Kain na!", hiligaynon: "Kaon na!", pronunciation: "KAH-in nah / KAH-on nah" },
  ...
  },
  {
    ...
    subtitle: "The Baking Academy opens â€” measuring, mixing, and the magic of the oven",
    emoji: "ðŸª",
    category: "Cooking",
    date: "2026-09-04",
    time: "9:00 AM",
    materials: ["1Â½ cups flour", "Â½ cup butter (softened)", "Â½ cup sugar", "1 egg", "1 tsp vanilla", "Â½ tsp baking soda, pinch of salt", "Mixing bowls, spoons, measuring cups", "Baking tray + oven (grown-up's job!)"],
    canvaLink: "https://www.canva.com/",
    videoLinks: [
    ...
    familyChallenge:
      "Head Baker Selah leads! After baking, decorate your cookies and give each one a name. Deliver a plate to someone outside your family â€” a neighbor, a friend â€” because the best part of baking is sharing it.",
    notes: "Baking Academy opens (Selah's unit). No linked recipe card â€” the simple recipe lives in the sections below. Teaches measuring (real math!), mixing, patience, sharing.",
    sections: [
      {
        heading: "Selah's Big Day",
        emoji: "ðŸ‘©â€ðŸ³",
        body: "Today the kitchen belongs to Selah. She ties on the apron, stands on the little stool, and looks at the flour, the butter, the sugar â€” and something wonderful happens. These plain, boring ingredients are about to become warm, golden cookies that make the whole house smell like a hug. That's the secret of baking: it's a little bit science, a little bit patience, and a whole lot of love. Welcome to the Baking Academy, explorers!",
      },
      {
        heading: "What You'll Bake",
        emoji: "ðŸ§º",
        body: "Gather your ingredients like a real baker â€” line them up before you start (bakers call this 'mise en place,' which just means 'everything in its place').",
        bullets: [
          "1Â½ cups flour Â· Â½ cup soft butter Â· Â½ cup sugar",
          "1 egg Â· 1 teaspoon vanilla",
          "Â½ teaspoon baking soda Â· a pinch of salt",
          "Makes about 12 cookies â€” enough to share!",
        ],
      },
      {
        heading: "Let's Bake! (Measuring Is Math)",
        emoji: "ðŸ¥„",
        body: "Here's the explorer's secret â€” baking is MATH you can eat. Every 'half cup' and 'one teaspoon' is a fraction; doubling the recipe is multiplication. Measure carefully and you're doing math without a worksheet!",
        bullets: [
          "1. Cream the soft butter and sugar until fluffy â€” count 100 stirs together!",
          "2. Mix in the egg and vanilla",
          "3. Add flour, baking soda, and salt â€” stir until it's dough",
          "4. Roll little balls, place on the tray, and let a grown-up bake at 180Â°C (350Â°F) for about 10 minutes",
          "5. Wait for them to cool (the hardest part!) â€” patience is a baking ingredient too",
        ],
      },
      {
        heading: "Baker's Words",
        emoji: "ðŸ’¬",
        body: "Every kitchen has its own language â€” learn the baker's words!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 25,
    title: "The Tarsier â€” Big Eyes in the Forest",
    ...
    familyChallenge:
      "Two-part animal adventure! Selah draws the tarsier's giant eyes up close; Rylee leads a tarsier mask craft from paper plates. Then everyone tries the tarsier challenge: sit perfectly STILL and QUIET for two whole minutes, like a tarsier hiding â€” hardest game ever!",
    ...
    sections: [
      {
        ...
        emoji: "ðŸŒ™",
        body: "It's midnight in the forest of Bohol, and something is watching. Two enormous round eyes â€” each one bigger than its own brain â€” blink from a tree branch. It's a tarsier: a creature so small it could sit in your palm, so shy it hides all day, and so special it lives almost nowhere else on Earth but here. It turns its head almost all the way around, like a tiny owl, fixes those huge eyes on a mothâ€¦ and leaps. Meet one of the Philippines' most precious little treasures.",
      },
      {
        ...
        bullets: [
          "One of the smallest primates on Earth â€” about the size of your fist",
          "Its eyes are so big it CAN'T move them â€” so it turns its head almost 180Â°, like an owl",
          "It can leap many times its own length between trees in the dark",
          "It talks in sounds too high for humans to hear â€” a secret song only tarsiers know",
        ],
      },
      {
        heading: "Tiny, and in Trouble",
        emoji: "ðŸŒ³",
        body: "Here's the serious part, explorers. Tarsiers are endangered â€” there aren't many left, because their forest homes are being cut down. They're so gentle and shy that being kept as pets makes them sad and sick. But the good news: Filipinos have built safe sanctuaries in Bohol where tarsiers live protected, and where visitors must be quiet and kind. Caring for the smallest creatures is part of caring for God's creation â€” every wide-eyed one matters.",
      },
      {
        heading: "Forest Words",
        emoji: "ðŸ’¬",
        body: "The vocabulary of the night forest â€” say the small words softly, like you might scare a tarsier!",
      },
    ],
    phrases: [
      { english: "Animal", tagalog: "Hayop", hiligaynon: "Sapat", pronunciation: "HAH-yop / sah-PAHT" },
  ...
  },
  {
    ...
    order: 26,
    title: "Helping Others â€” Tulong",
    subtitle: "Serving one another humbly in love â€” the Filipino way of the helping hand",
    emoji: "ðŸ¤²",
    category: "Values",
    date: "2026-09-09",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Start a Helper's Jar this week. Every time someone in the family helps another person â€” without being asked â€” write it on a slip and drop it in. On Friday, read them all aloud together and thank each helper. Watch the jar fill up with love!",
    notes: "Unit 4/11 Values. Verse: Galatians 5:13. Includes Story Â· Discussion Â· Reflection Â· Challenge Â· Real example (per CONTENT_GUIDELINES values structure). Deepens the bayanihan lesson.",
    sections: [
      {
        heading: "The Boy Who Carried the Basket",
        emoji: "ðŸ§º",
        body: "Old Aling Rosa was walking home from the market, her basket heavy with rice and vegetables, stopping every few steps to rest her tired arms. A boy named Miguel was playing basketball with his friends nearby. He could have kept playing â€” nobody would have blamed him. But he saw her, jogged over, and simply said, 'Ako na po' â€” let me carry it. He walked the whole way to her door, chatting about her grandchildren, then ran back to his game. He didn't do it for a reward. He did it because a heavy basket and a helping hand belong together.",
      },
      {
        heading: "Let's Talk About It",
        emoji: "ðŸ’¬",
        body: "Gather close â€” this is family table talk, not a test. There are no wrong answers.",
        bullets: [
          ...
          "Who around us â€” at home, next door, at church â€” might need a helping hand this week?",
        ],
      },
      {
      ...
      },
      {
        ...
        emoji: "ðŸ¤",
        body: "Say these â€” then go find someone to say 'Ako na' to!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    subtitle: "Little cakes with big hats of frosting â€” where baking becomes art",
    emoji: "ðŸ§",
    category: "Cooking",
    date: "2026-09-11",
    time: "9:00 AM",
    materials: ["1 cup flour", "Â½ cup sugar", "â…“ cup butter (soft)", "1 egg, Â½ cup milk", "1 tsp baking powder, splash of vanilla", "Frosting + sprinkles for decorating", "Cupcake liners + muffin tray (oven = grown-up!)"],
    canvaLink: "https://www.canva.com/",
    videoLinks: [
    ...
    familyChallenge:
      "Cupcake Art Show! Everyone decorates their own cupcake into a 'character' â€” a face, an animal, a tiny scene. Selah is head judge. Photograph your gallery for the Family Cookbook before you eat the artwork!",
    ...
    sections: [
      {
        ...
        emoji: "ðŸ§",
        body: "Last week we baked cookies â€” today we go BIGGER (well, taller!). A cupcake is a whole little cake that fits in your hand, wearing a swirl of frosting like a fancy hat. The best part? Every single one can be different. In a Filipino fiesta, the dessert table is a rainbow, and cupcakes are little edible gifts you can decorate to match anyone you love. Aprons on â€” today the Baking Academy becomes an art studio.",
      },
      {
        heading: "What You'll Bake",
        emoji: "ðŸ§º",
        body: "Line up your ingredients first â€” a good baker is a tidy baker!",
        bullets: [
          "1 cup flour Â· Â½ cup sugar Â· â…“ cup soft butter",
          "1 egg Â· Â½ cup milk Â· a splash of vanilla",
          "1 teaspoon baking powder",
          "Makes about 8 cupcakes â€” plus frosting and sprinkles to decorate",
        ],
      },
      {
        heading: "Let's Bake! (Follow the Order)",
        emoji: "ðŸ¥„",
        body: "Baking is like a treasure map â€” the steps must happen IN ORDER, or the treasure doesn't appear. Read each step aloud before you do it!",
        bullets: [
          "1. Cream soft butter and sugar until pale and fluffy",
          "2. Beat in the egg and vanilla, then add milk",
          "3. Gently stir in flour and baking powder â€” don't over-mix!",
          "4. Spoon into liners, filling each â…” full (that's a fraction â€” leave room to rise!)",
          "5. Grown-up bakes at 180Â°C (350Â°F) about 18 minutes; cool completely, THEN decorate",
        ],
      },
      {
    ...
    reflection: "You made a cupcake into something special just for someone. Who did you think of â€” and why them?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    id: "philippine-eagle-king-of-the-sky",
    order: 28,
    title: "The Philippine Eagle â€” King of the Sky",
    subtitle: "One of the biggest, rarest eagles on Earth â€” the proud national bird",
    emoji: "ðŸ¦…",
    category: "Philippines",
    date: "2026-09-14",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Become Eagle Guardians! Rylee leads a feather-craft or eagle-wing drawing. Then make paper-roll 'spyglasses' and go on a backyard bird-watch â€” count every bird you spot and give thanks that your family is helping watch over God's flying creatures.",
    notes: "Unit 6 Animals. The national bird â€” pairs with the national symbols lesson (Lesson 5). Strong stewardship theme; critically endangered. Rylee (animals) leads.",
    sections: [
      {
        heading: "The Shadow with a Ten-Foot Reach",
        emoji: "ðŸŒ¤ï¸",
        body: "High over the rainforests of Mindanao, a shadow slides across the treetops. Look up â€” it's enormous. Wings wider than a doorway, a proud crown of feathers standing up like a lion's mane, and eyes that can spot a monkey moving in the leaves from far, far away. This is the Philippine Eagle, once called the 'monkey-eating eagle,' now known by a prouder name: Haribon â€” from 'Hari ng mga Ibon,' the KING of the birds. And it lives nowhere on Earth but here.",
      },
      {
        heading: "A Bird of Records",
        emoji: "ðŸ¦…",
        body: "The Philippine Eagle is one of the largest and most powerful eagles alive â€” and the national bird of the Philippines.",
        bullets: [
          "Wingspan up to 2 meters â€” stretch your arms wide, then imagine wider!",
          ...
          "Declared the national bird â€” harming one is against the law in the Philippines",
        ],
      },
      {
        heading: "The King That Needs Our Help",
        emoji: "ðŸŒ³",
        body: "Here's the part that matters most, Eagle Guardians. There are only a few hundred Philippine Eagles left in the wild â€” they're critically endangered, because their rainforest homes are disappearing. But Filipinos refuse to let the king fall: scientists at the Philippine Eagle Center raise eaglets and release them, and schoolchildren all over the country plant trees to grow the forests back. Protecting the mightiest bird is part of caring for all of God's creation â€” even the king of the sky needs a helping hand.",
      },
      {
        heading: "Words That Soar",
        emoji: "ðŸ’¬",
        body: "Sky words and bird words â€” say them big and bold, like an eagle's cry!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 29,
    title: "Gratitude â€” A Thankful Heart",
    subtitle: "Giving thanks in all things â€” the secret to a happy Filipino home",
    emoji: "ðŸ™",
    category: "Values",
    date: "2026-09-16",
    time: "9:00 AM",
    ...
    familyChallenge:
      "Build a Gratitude Jar for the whole family. Each night this week, everyone writes (or draws) ONE thing they're thankful to God for and drops it in. Next Sunday, read them all aloud â€” a jar full of blessings you almost forgot you had.",
    ...
    sections: [
      ...
      },
      {
        ...
        emoji: "ðŸ“–",
        body: "The Bible gives gratitude a beautiful home: 'Give thanks in all circumstances.' (1 Thessalonians 5:18) Not only on the good days â€” in ALL of them. That's the secret Lola knew. A thankful heart doesn't wait for everything to be perfect; it finds the gifts already there. This is why every Wonder Journey morning begins with Morning Blessings â€” we start each day counting what's here.",
      },
      {
        heading: "Words of Thanks",
        emoji: "ðŸ’›",
        body: "The most important words in any language â€” say them like you mean them!",
      },
    ],
    phrases: [
      { english: "Thank you", tagalog: "Salamat", hiligaynon: "Salamat", pronunciation: "sah-LAH-maht" },
    ...
    reflection: "Ana felt richer just by remembering her blessings. What are three things you're thankful to God for right now â€” small ones count most!",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    subtitle: "Warm, chocolatey squares â€” and a little kitchen chemistry",
    emoji: "ðŸ«",
    category: "Cooking",
    date: "2026-09-18",
    time: "9:00 AM",
    materials: ["Â½ cup butter", "1 cup sugar", "2 eggs, 1 tsp vanilla", "Â½ cup flour", "â…“ cup cocoa powder, pinch of salt", "Square pan + oven (grown-up!)"],
    canvaLink: "https://www.canva.com/",
    videoLinks: [
      { label: "Easy brownies with kids (search on YouTube)", url: "https://www.youtube.com/results?search_query=easy+fudgy+brownies+kids" },
    ],
    familyChallenge:
      "The Great Cut-and-Share: brownies are baked in one big pan, so YOU must divide them fairly for everyone (more fraction math â€” halves, quarters, equal squares!). Then deliver two squares to someone who had a hard week.",
    ...
    sections: [
      {
        ...
        emoji: "ðŸ«",
        body: "There is no smell on Earth quite like brownies in the oven. It drifts through the whole house, and one by one, everyone appears in the kitchen doorway with the same hopeful question in their eyes: 'Is it ready yet?' Brownies are the coziest thing the Baking Academy makes â€” a little crackly on top, warm and fudgy inside. Today we bake happiness in a square pan, and then we do the hardest, most generous thing: we share it fairly.",
      },
      {
        heading: "What You'll Bake",
        emoji: "ðŸ§º",
        ...
        bullets: [
          "Â½ cup melted butter Â· 1 cup sugar",
          "2 eggs Â· 1 teaspoon vanilla",
          "Â½ cup flour Â· â…“ cup cocoa powder Â· a pinch of salt",
          "Makes one pan â€” enough squares to share generously",
        ],
      },
      {
        heading: "Let's Bake! (A Little Chemistry)",
        emoji: "ðŸ”¬",
        body: "Watch the science! A grown-up MELTS the butter â€” solid turns to liquid with heat. Cocoa powder is dried, ground-up chocolate that wakes up when it meets the wet ingredients. Baking is chemistry you can eat!",
        bullets: [
          "1. Grown-up melts the butter, then stir in the sugar",
          "2. Beat in eggs and vanilla until glossy",
          "3. Sift in flour, cocoa, and salt â€” fold gently until just mixed",
          "4. Pour into the pan and smooth the top",
          "5. Grown-up bakes at 175Â°C (350Â°F) about 25 minutes; cool before cutting so they hold their shape",
        ],
      },
      {
        heading: "Chocolate Kitchen Words",
        emoji: "ðŸ’¬",
        body: "The vocabulary of the coziest bake â€” say the sweet ones twice!",
      },
    ],
    phrases: [
    ...
    reflection: "Sharing one pan fairly takes both math AND kindness. Was it easy or hard to share equally â€” and who did you choose to give brownies to?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    id: "carabao-the-farmers-best-friend",
    order: 31,
    title: "The Carabao â€” The Farmer's Best Friend",
    ...
    canvaLink: "https://www.canva.com/",
    videoLinks: [
      { label: "Carabao â€” the Filipino water buffalo (search on YouTube)", url: "https://www.youtube.com/results?search_query=carabao+philippines+farm" },
    ],
    familyChallenge:
      "Asa leads a Carabao Build! Sculpt a carabao from clay and build it a little cart or plow from craft sticks. Then try the 'carabao's job': everyone slowly, patiently pulls a loaded laundry basket across the room â€” feel how hard the carabao works every single day!",
    notes: "Unit 6 Animals. The beloved national animal / hardest worker in the barrio â€” pairs with the National Symbols lesson. Asa (building/animals/vehicles) leads. Tagalog-only vocabulary.",
    sections: [
      {
        heading: "Before the Sun, the Carabao",
        emoji: "ðŸŒ…",
        body: "Long before the rooster finishes crowing, Mang Tino is already in the rice field â€” and beside him, calm and enormous, is Toto the carabao. Together they walk the muddy rows, the carabao pulling the heavy plow through the earth without complaint, its great curved horns swinging slowly, its wide feet made perfectly for the mud. When the sun gets hot, Toto sinks into a cool puddle with a happy sigh. Farmer and carabao have worked side by side like this in the Philippines for hundreds of years â€” the truest of friends.",
      },
      {
        heading: "The Gentle Giant of the Barrio",
        emoji: "ðŸƒ",
        body: "The carabao â€” a kind of water buffalo â€” is the beloved national animal of the Philippines, and the hardest worker in the countryside.",
        bullets: [
          "Incredibly strong â€” it pulls plows and carts loaded with rice, coconuts, and firewood",
          "Loves water and mud â€” a cool wallow keeps its skin protected from the hot sun",
          "Gives creamy milk that makes a special cheese called kesong puti and the sweet treat pastillas",
          "Famous for being patient and gentle â€” Filipinos even call a calm, hardworking person 'parang carabao' (like a carabao)",
        ],
      },
      {
        heading: "Slow, Steady, and Strong",
        emoji: "ðŸ’ª",
        body: "The carabao teaches something the fast world forgets: you don't have to be quick to be mighty. Step by patient step, the carabao helped grow the rice that fed the nation and helped carve those Banaue terraces we visited. It never rushes and it never quits. When your family has a big, hard, slow job ahead â€” remember Toto. Steady wins.",
      },
      {
        heading: "Farm Words (Tagalog)",
        emoji: "ðŸ’¬",
        body: "The vocabulary of the rice field â€” say each one, then use it while you build!",
      },
    ],
    phrases: [
    ...
    reflection: "The carabao is strong because it's patient and never quits. What's a slow, hard job your family can tackle 'like a carabao' â€” one steady step at a time?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    ...
    subtitle: "Turning too-ripe bananas into the coziest loaf â€” nothing wasted, everything loved",
    emoji: "ðŸž",
    category: "Cooking",
    date: "2026-09-25",
    time: "9:00 AM",
    materials: ["3 very ripe bananas", "â…“ cup melted butter", "Â½ cup sugar, 1 egg, 1 tsp vanilla", "1Â½ cups flour, 1 tsp baking soda, pinch of salt", "A loaf pan + oven (grown-up!)"],
    canvaLink: "https://www.canva.com/",
    videoLinks: [
    ...
    familyChallenge:
      "Banana Bread Kindness Delivery: your loaf makes the house smell amazing â€” so bake it, slice it, wrap two pieces, and bring them warm to a neighbor or friend 'just because.' Baking is best when it leaves your own kitchen.",
    ...
    sections: [
      {
        ...
        emoji: "ðŸŒ",
        body: "On the kitchen counter sit three sad bananas â€” brown, spotty, too soft to peel and eat. Most people would throw them away. But a Filipino lola knows a secret: those are not spoiled bananas. Those are banana bread WAITING to happen! The riper and browner the banana, the sweeter and cozier the loaf. Today the Baking Academy performs a little kitchen magic â€” turning something nobody wanted into something everybody loves. Nothing wasted, everything loved.",
      },
      {
        heading: "What You'll Bake",
        emoji: "ðŸ§º",
        body: "The riper the bananas, the better â€” this is the recipe that saves them!",
        bullets: [
          "3 very ripe (brown-spotted) bananas Â· â…“ cup melted butter",
          "Â½ cup sugar Â· 1 egg Â· 1 teaspoon vanilla",
          "1Â½ cups flour Â· 1 teaspoon baking soda Â· a pinch of salt",
          "Makes one loaf â€” about 8 cozy slices to share",
        ],
      },
      {
        heading: "Let's Bake! (Mash and Mix)",
        emoji: "ðŸ¥„",
        body: "This is the most fun mixing job in the whole Academy â€” the mashing! Little hands are perfect for it.",
        bullets: [
          "1. Mash the ripe bananas with a fork until smooth (squish away â€” get the wiggles out!)",
          "2. Stir in the melted butter, then the sugar, egg, and vanilla",
          "3. Sprinkle in flour, baking soda, and salt â€” fold gently until just combined",
          "4. Pour into the loaf pan",
          "5. Grown-up bakes at 175Â°C (350Â°F) about 50 minutes â€” the whole house will smell like a hug",
        ],
      },
      {
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    familyChallenge:
      "Measure a whale shark in your own home! A butanding can reach 10 meters â€” use a measuring tape to mark 10 meters down your hallway or yard (that's the whole fish!). Then draw its spotted back on paper: every whale shark's spots are unique, like a fingerprint â€” invent your family's own spot pattern.",
    notes: "Unit 6 Animals â€” the sea giants. Conservation/stewardship thread continues. Tagalog-only vocabulary.",
    sections: [
      {
        heading: "The Shadow Bigger Than the Boat",
        emoji: "ðŸŒŠ",
        body: "The fishermen of Donsol were mending nets when the water beside their little boat went dark. Something enormous was rising â€” bigger than the boat itself â€” and the youngest fisherman gripped the side. Then it surfaced: a mouth as wide as a doorway, a back covered in white polka dots, moving slow as a cloud. 'Butanding,' the old fisherman smiled, not afraid at all. 'The gentle one.' The biggest fish in the entire ocean â€” and it eats only tiny, tiny plankton, and has never hurt anyone.",
      },
      {
        ...
        bullets: [
          "The whale shark (butanding) â€” the world's BIGGEST fish, up to 10 meters, with spots unique as fingerprints",
          "It's not a whale! It's a shark â€” but a filter-feeder that swims with its giant mouth open for plankton",
          "The pawikan (sea turtle) â€” can live for decades and swims thousands of kilometers, yet returns to the very beach where it hatched to lay its own eggs",
          "Baby turtles hatch at night and race to the sea by moonlight â€” one of nature's bravest journeys",
        ],
      },
      {
        heading: "Guardians of the Giants",
        emoji: "ðŸ›¡ï¸",
        body: "Filipinos protect both giants fiercely. In Donsol, whale-shark tourism follows strict kind rules â€” no touching, no chasing, keep your distance. On beaches all over the country, volunteers guard pawikan nests at night and escort the hatchlings safely to the waves. When people choose gentleness toward the biggest fish and the smallest hatchling alike, that's stewardship of God's ocean â€” and kids can be guardians too.",
      },
      {
        heading: "Ocean Words (Tagalog)",
        emoji: "ðŸ’¬",
        body: "The vocabulary of the deep blue â€” say them in a slow, giant voice!",
      },
    ],
    phrases: [
  ...
  },
  {
    ...
    order: 34,
    title: "The Rainforest â€” A Green Cathedral",
    ...
    familyChallenge:
      "Asa leads a Rainforest Expedition! Build a shoebox rainforest with its four layers â€” forest floor, understory, canopy, emergent giants â€” using real leaves and twigs you gather outside. Hide a paper tarsier and an eagle inside for the family to find (they're hiding in the real one too!).",
    ...
    reflection: "The forest quietly takes care of the islands â€” holding the soil, cleaning the air, sheltering the animals. Who quietly takes care of things in YOUR family, and how can you thank them today?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
  {
    id: "pancit-long-life-noodles",
    order: 35,
    title: "Pancit â€” The Long-Life Noodles",
    subtitle: "The birthday dish of the Philippines â€” long noodles for a long, happy life",
    emoji: "ðŸœ",
    category: "Cooking",
    recipeId: "pancit",
    date: "2026-10-09",
    ...
    familyChallenge:
      "The Longest Noodle Ceremony! At the table, everyone lifts their noodles high with their fork before the first bite â€” the higher the lift, the longer the life, say the lolas. Measure who found the longest unbroken noodle. Then each person shares one hope for their long, happy life.",
    notes: "Unit 7 Cooking â€” linked to the existing pancit recipe. Birthday-tradition framing (and a wink: Sharon's birthday was in July, but pancit is for EVERY celebration). Tagalog-only vocabulary.",
    sections: [
      {
        heading: "The Dish That Comes to Every Birthday",
        emoji: "ðŸŽ‚",
        body: "At every Filipino birthday party â€” every single one â€” somewhere on the table sits a great glorious platter of pancit: golden noodles tangled with vegetables, chicken, and little shrimp, glistening and fragrant. Why always pancit? Lean close, because every lola will tell you the same secret: the noodles are LONG, and long noodles mean LONG LIFE. Cutting them short is bad luck â€” you lift them high and slurp them whole. It's a wish you can eat.",
      },
      {
        ...
        bullets: [
          "Noodles came to the islands with Chinese traders long ago â€” 'pancit' comes from a Hokkien word for something conveniently cooked",
    ...
    reflection: "Pancit carries a wish for long life. If you could cook one wish into a dish for someone you love, what would the wish be â€” and who gets the first plate?",
    gratitudePrompt: "Today I am grateful to the Lord because...",
  },
];
