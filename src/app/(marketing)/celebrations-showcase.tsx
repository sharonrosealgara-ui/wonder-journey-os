...
export default function CelebrationsShowcase() {
  ...
  return (
    <section id="celebrations" className="py-14 sm:py-20 md:py-28 bg-sand/20 border-b border-sand-deep/50 relative overflow-hidden">
      <div className="max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1920px] 4k:max-w-[2400px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4k:px-16">
        ...
        <div className="text-center max-w-3xl 2xl:max-w-4xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sunset/15 border border-sunset/30 text-sunset-deep text-xs sm:text-sm font-bold tracking-wide mb-3">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-14 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="wj-card p-6 sm:p-8 bg-white border-2 border-sand-deep/70 rounded-3xl shadow-sm relative overflow-hidden">
              <div className="flex items-center justify-between gap-4 mb-4 pb-3 border-b border-sand-deep/40">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-display text-sm sm:text-base font-bold text-ocean-deep">
                    Authentic Student Keepsakes
                  </span>
                </div>
                {/* Privacy Badge */}
                <span className="text-[10px] sm:text-xs font-bold px-2.5 py-1 rounded-full bg-sand/80 text-ink/75 border border-sand-deep/60">
              ...
              <div className="grid sm:grid-cols-2 gap-5 mt-4">
                ...
                <div className="p-4 rounded-2xl bg-paper border border-sand-deep/70 flex flex-col justify-between relative group hover:border-sand-deep transition-all">
                  <div className="aspect-[4/3] rounded-xl bg-sand/40 border border-sand-deep/50 flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
                    ...
                    <p className="font-display text-xs text-ocean-deep font-bold leading-snug">
                      &ldquo;Happy Birthday, Teacher Sharon!&rdquo;
                    </p>
                    <p className="text-[10px] text-ink/70 mt-1 font-mono">
                      Handmade Crayon & Marker Card
                    </p>
                    {/* Consent Gateway Pill */}
                    <div className="mt-3 px-2 py-0.5 rounded-full bg-sand-deep/30 text-[9px] font-bold text-ocean-deep tracking-tight">
              ...
              <div className="mt-5 p-3 rounded-xl bg-sand/40 border border-sand-deep/50 flex items-start gap-2.5 text-[11px] text-ink/75 leading-relaxed font-medium">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="wj-card p-6 sm:p-8 bg-white border-2 border-sand-deep/70 rounded-3xl shadow-sm">
              ...
              <p className="text-xs sm:text-sm text-ink/85 font-semibold mb-5 leading-relaxed">
              ...
              <div className="p-5 rounded-2xl bg-paper border border-sand-deep/70 text-center">
                <div className="text-xs font-mono font-bold text-ocean-deep uppercase tracking-wider mb-3">
                ...
                <div className="mt-4 text-[10px] font-mono text-ink/60 uppercase tracking-widest">
                  Flow: Record &rarr; Stop &rarr; Preview &rarr; Re-record
                </div>
                <div className="mt-1 text-[10px] font-mono font-bold text-sunset-deep tracking-wider">
                  No Send. No Upload.
                </div>
              </div>
              ...
              <div className="mt-5 p-4 rounded-2xl bg-sand/30 border border-sand-deep/50 text-left">
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-mango-deep">
                    Teacher Blessing &bull; Static Preview
                  </span>
                  <span className="text-[9px] font-mono font-bold text-ink/60 px-2 py-0.5 rounded-full bg-sand-deep/30">
                    Visual Preview Only
                  </span>
                </div>
                <p className="font-display text-xs sm:text-sm font-bold text-ocean-deep">
                  Teacher Blessing &amp; Encouragement
                </p>

                {/* Decorative Waveform Presentation (Clearly Presented as Non-Functioning Visual Preview Decoration) */}
                ...
                <p className="text-[11px] text-ink/70 mt-2.5 leading-relaxed font-medium">
